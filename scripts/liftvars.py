...
hl.init(spark_conf=config, master=f'local[{args.all_cpus}]')
...
full_ht = full_ht.checkpoint('A.ht', overwrite=True)

full_ht = full_ht.key_by('locus', 'alleles')
